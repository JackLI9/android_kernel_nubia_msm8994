...
static struct device_attribute attrs_prox[] = {
    __ATTR(chip_name,                       0440,   tmg399x_chip_name_show,                 NULL), 
	__ATTR(enable,                          0640,   tmg399x_prox_enable_show,               tmg399x_prox_enable_store),
    __ATTR(prox_init,                       0220,   NULL,                                   tmg399x_prox_init_store),
	__ATTR(prox_threshold_init,             0220,   NULL,                                   tmg399x_prox_threshold_init_store),
    __ATTR(prox_offset_init,                0220,   NULL,                                   tmg399x_prox_offset_init_store),
	...
	__ATTR(prox_data,                       0440,   tmg399x_prox_data_show,                 NULL),
	__ATTR(prox_detect,                     0440,   tmg399x_prox_detected_show,             NULL),
    __ATTR(prox_calibrate,                  0220,   NULL,                                   tmg399x_prox_calibrate_store), 
    ...
    __ATTR(prox_calibrate_result,           0440,   tmg399x_prox_calibrate_result_show,     NULL), 
    ...
    __ATTR(prox_wakelock,                   0440,   tmg399x_prox_wakelock_show,             tmg399x_prox_wakelock_store),
    __ATTR(prox_thres_max,                  0444,   tmg399x_prox_thres_hi_max,              NULL), 
    __ATTR(prox_thres_min,                  0444,   tmg399x_prox_thres_hi_min,              NULL),
    ...
    __ATTR(prox_manual_calibrate_threshold, 0444,   tmg399x_manual_calibrate_threshold,     NULL), 
    ...
    __ATTR(tmg_clear_irq,                   0220,   NULL,                                   tmg399x_irq_clear),
    ...
    __ATTR(chip_dump,                       0444,   tmg399x_dump_show,                      NULL),
};
...
static struct device_attribute attrs_gesture[] = {
    ...
    __ATTR(gesture_offset_init,         0220,   NULL,                                       tmg399x_gesture_offset_init_store),
    ...
    __ATTR(gesture_start_flag,          0220,   NULL,                                       tmg399x_set_ges_start),
    ...
    __ATTR(clear_irq,                   0220,   NULL,                                       tmg399x_irq_clear),
};
...
static struct device_attribute attrs_light[] = {
	...
	__ATTR(light_lux,               0440,   tmg399x_device_als_lux,              NULL),
	__ATTR(light_red,               0440,   tmg399x_als_red_show,                NULL),
	__ATTR(light_green,             0440,   tmg399x_als_green_show,              NULL),
	__ATTR(light_blue,              0440,   tmg399x_als_blue_show,               NULL),
	__ATTR(light_clear,             0440,   tmg399x_als_clear_show,              NULL),
	__ATTR(light_cct,               0440,   tmg399x_als_cct_show,                NULL),
    __ATTR(light_debug,             0440,   tmg399x_light_debug_show,            tmg399x_light_debug_store),
};
...
#define TMG399X_VDD_MIN_UV	2000000
#define TMG399X_VDD_MAX_UV	3300000
#define TMG399X_VIO_MIN_UV	1750000
#define TMG399X_VIO_MAX_UV	1950000

static int tmg399x_power_init(struct tmg399x_chip *chip, bool on)
{
	int rc = 0;
...
err_vdd_enable:
	if (regulator_count_voltages(chip->vio) > 0)
		regulator_set_voltage(chip->vio, 0, TMG399X_VIO_MAX_UV);
err_vio_set:
	regulator_put(chip->vio);
err_vio_get:
	if (regulator_count_voltages(chip->vdd) > 0)
		regulator_set_voltage(chip->vdd, 0, TMG399X_VDD_MAX_UV);
err_vdd_set:
	regulator_put(chip->vdd);
	return rc;
}
